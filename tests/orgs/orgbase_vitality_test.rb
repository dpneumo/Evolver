...
class OrgbaseVitalityTest < Minitest::Test
  ...
  def test_orgbase_survival_probability_ignores_an_age_lt_0
    age = -1
    color = 'test_color1'
    assert_equal 1.0, Orgbase.survival_probability(age: age, color: color)
  end
  ...
  def test_orgbase_survival_probability_returns_1_if_age_is_nil
    age = nil
    color = 'test_color1'
    assert_equal 1.0, Orgbase.survival_probability(age: age, color: color)
  end

  def test_orgbase_survival_probability_returns_1_if_color_is_nil
    age = 4
    color = nil
    assert_equal 1.0, Orgbase.survival_probability(age: age, color: color)
  end
