...
require_relative '../../../../utilities/critters/critter/vitality'

class Tests::Utilities::Critters::Critter::VitalityTest < Minitest::Test
  def setup
    resource = MockToolbox.new.resource
    @vitality = Utilities::Critters::Critter::Vitality.new(resource: resource)
  end
