...
require_relative '../../../../utilities/critters/coyote/vitality'

class Tests::Utilities::Critters::Coyote::VitalityTest < Minitest::Test
  def setup
    resource = MockToolbox.new.resource
    @vitality = Utilities::Critters::Coyote::Vitality.new(resource: resource)
  end
